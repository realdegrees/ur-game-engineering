...
[CreateAssetMenu(fileName = "AccelerateState", menuName = "StateMachines/States/Enemy/AccelerateState")]
public class EnemyAccelerateState : EnemyState
{
    private float startVelocity;
    private float accelerationRate;
    public EnemyAccelerateState() : base(EEnemyState.Accelerating)
    {
    }
